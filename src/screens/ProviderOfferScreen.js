...
const ProviderOfferScreen = ({navigation}) => {
  const {getAvailableRequests, submitOffer, getOffersForRequest} = useApp();
  ...
  return (
    <SafeAreaView style={styles.container} edges={['bottom']}>
      <Header title="Request" showBack onBackPress={handleBack} />
                ...
                <Card key={request.id} style={styles.requestCard}>
                  ...
                  <View style={styles.locationSection}>
                    <View style={styles.locationRow}>
                      ...
                      <Text style={styles.locationValue}>{request.from}</Text>
                    </View>
                    <View style={styles.locationRow}>
                      <Text style={styles.locationLabel}>To:</Text>
                      <Text style={styles.locationValue}>{request.to}</Text>
                    </View>
                  </View>
